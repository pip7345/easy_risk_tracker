...
// Copy demo project to public/demo
const demoSource = path.join(__dirname, '..', 'demo');
const demoDest = path.join(publicDir, 'demo');

if (fs.existsSync(demoSource)) {
    fs.rmSync(demoDest, { recursive: true, force: true });
    fs.cpSync(demoSource, demoDest, { recursive: true });
